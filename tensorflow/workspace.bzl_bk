...
def tf_workspace(path_prefix = "", tf_repo_name = ""):
  ...
  native.new_http_archive(
      name = "eigen_archive",
      urls = [
          "http://192.168.1.252:8888/eigen_archive.tar.gz",
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://192.168.1.252:8888/libxsmm_archive.tar.gz",
  ...
  native.http_archive(
      ...
      urls = [
          "http://192.168.1.252:8888/com_googlesource_code_re2.tar.gz",
  ...
  native.http_archive(
      name = "gemmlowp",
      urls = [
          "http://192.168.1.252:8888/gemmlowp.tar.gz",
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://192.168.1.252:8888/farmhash_archive.zip",
  ...
  native.http_archive(
      name = "highwayhash",
      urls = [
          "http://192.168.1.252:8888/highwayhash.tar.gz",
  ...
  native.new_http_archive(
      name = "nasm",
      urls = [
          "http://192.168.1.252:8888/nasm.tar.bz2",
  ...
  native.new_http_archive(
      name = "jpeg",
      urls = [
          "http://192.168.1.252:8888/jpeg.tar.gz",
  ...
  native.new_http_archive(
      name = "png_archive",
      urls = [
          "http://192.168.1.252:8888/png_archive.zip",
  ...
  native.new_http_archive(
      name = "gif_archive",
      urls = [
          "http://192.168.1.252:8888/gif_archive.tar.gz",
  ...
  native.new_http_archive(
      name = "six_archive",
      urls = [
          "http://192.168.1.252:8888/six_archive.tar.gz",
  ...
  native.http_archive(
      name = "protobuf",
      urls = [
          "http://192.168.1.252:8888/protobuf.tar.gz",
  ...
  native.new_http_archive(
      name = "gmock_archive",
      urls = [
          "http://192.168.1.252:8888/gmock_archive.zip",
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://192.168.1.252:8888/pcre.tar.gz",
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://192.168.1.252:8888/swig.tar.gz",
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://192.168.1.252:8888/curl.tar.gz",
  ...
  native.new_http_archive(
      name = "grpc",
      urls = [
          "http://192.168.1.252:8888/grpc.tar.gz",
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://192.168.1.252:8888/linenoise.tar.gz",
  ...
  native.new_http_archive(
      name = "llvm",
      urls = [
          "http://192.168.1.252:8888/llvm.tar.gz",
  ...
  native.new_http_archive(
      name = "jsoncpp_git",
      urls = [
          "http://192.168.1.252:8888/jsoncpp_git.tar.gz",
  ...
  native.http_archive(
      name = "boringssl",
      urls = [
          "http://192.168.1.252:8888/boringssl.tar.gz",
  ...
  native.new_http_archive(
      name = "nanopb_git",
      urls = [
          "http://192.168.1.252:8888/nanopb_git.tar.gz",
  ...
  native.new_http_archive(
      name = "zlib_archive",
      urls = [
          "http://192.168.1.252:8888/zlib_archive.tar.gz",
  ...
  native.http_jar(
      name = "junit_jar",
      url = "http://192.168.1.252:8888/junit_jar.jar",
