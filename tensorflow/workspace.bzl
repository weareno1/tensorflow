...
def tf_workspace(path_prefix = "", tf_repo_name = ""):
  ...
  native.new_http_archive(
      name = "eigen_archive",
      urls = [
          "http://192.168.1.252:8888/weareno1/eigen_archive.tar.gz",
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://192.168.1.252:8888/weareno1/libxsmm_archive.tar.gz",
  ...
  native.http_archive(
      ...
      urls = [
          "http://192.168.1.252:8888/weareno1/com_googlesource_code_re2.tar.gz",
  ...
  native.http_archive(
      name = "gemmlowp",
      urls = [
          "http://192.168.1.252:8888/weareno1/gemmlowp.tar.gz",
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://192.168.1.252:8888/weareno1/farmhash_archive.zip",
  ...
  native.http_archive(
      name = "highwayhash",
      urls = [
          "http://192.168.1.252:8888/weareno1/highwayhash.tar.gz",
  ...
  native.new_http_archive(
      name = "nasm",
      urls = [
          "http://192.168.1.252:8888/weareno1/nasm.tar.bz2",
  ...
  temp_workaround_http_archive(
      name = "jpeg",
      urls = [
          "http://192.168.1.252:8888/weareno1/jpeg.tar.gz",
  ...
  native.new_http_archive(
      name = "png_archive",
      urls = [
          "http://192.168.1.252:8888/weareno1/png_archive.zip",
  ...
  native.new_http_archive(
      name = "gif_archive",
      urls = [
          "http://192.168.1.252:8888/weareno1/gif_archive.tar.gz",
  ...
  native.new_http_archive(
      name = "six_archive",
      urls = [
          "http://192.168.1.252:8888/weareno1/six_archive.tar.gz",
  ...
  native.http_archive(
      name = "protobuf",
      urls = [
          "http://192.168.1.252:8888/weareno1/protobuf.tar.gz",
  ...
  native.new_http_archive(
      name = "gmock_archive",
      urls = [
          "http://192.168.1.252:8888/weareno1/gmock_archive.zip",
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://192.168.1.252:8888/weareno1/pcre.tar.gz",
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://192.168.1.252:8888/weareno1/swig.tar.gz",
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://192.168.1.252:8888/weareno1/curl.tar.gz",
  ...
  native.new_http_archive(
      name = "grpc",
      urls = [
          "http://192.168.1.252:8888/weareno1/grpc.tar.gz",
  ...
  native.new_http_archive(
      ...
      urls = [
          "http://192.168.1.252:8888/weareno1/linenoise.tar.gz",
  ...
  temp_workaround_http_archive(
      name = "llvm",
      urls = [
          "http://192.168.1.252:8888/weareno1/llvm_r1.0.tar.gz",
  ...
  native.new_http_archive(
      name = "jsoncpp_git",
      urls = [
          "http://192.168.1.252:8888/weareno1/jsoncpp_git.tar.gz",
  ...
  native.http_archive(
      name = "boringssl",
      urls = [
          "http://192.168.1.252:8888/weareno1/boringssl.tar.gz",
  ...
  native.new_http_archive(
      name = "nanopb_git",
      urls = [
          "http://192.168.1.252:8888/weareno1/nanopb_git.tar.gz",
  ...
  native.new_http_archive(
      name = "zlib_archive",
      urls = [
          "http://192.168.1.252:8888/weareno1/zlib_archive.tar.gz",
  ...
  native.new_http_archive(
      name = "nccl_archive",
      url = "http://192.168.1.252:8888/weareno1/nccl_archive.tar.gz",
  ...
  native.http_jar(
      name = "junit_jar",
      url = "http://192.168.1.252:8888/weareno1/junit_jar.jar",
